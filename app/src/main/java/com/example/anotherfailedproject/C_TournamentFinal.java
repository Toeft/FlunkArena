...
public class C_TournamentFinal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c_tournament_final);
        ...
        {
            MatchPlayersTextView[i].setText(TournamentData.TeamListFinal.get(i).printPlayers());
        }
        ...
        {
            MatchTeamNameTextView[i].setText(TournamentData.TeamListFinal.get(i).getTeamName());
            TournamentData.TeamListFinal.get(i).doneList = new boolean[TournamentData.TeamSize];
        }
    ...
    public void onClick(View v) {
        ...
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[0] =
                    switchPlayerDone(PopupTextViewT1[1], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[0]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT1[2])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[1] =
                    switchPlayerDone(PopupTextViewT1[2], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[1]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT1[3])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[2] =
                    switchPlayerDone(PopupTextViewT1[3], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[2]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT1[4])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[3] =
                    switchPlayerDone(PopupTextViewT1[4], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)).doneList[3]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        ...
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[0] =
                    switchPlayerDone(PopupTextViewT2[1], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[0]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT2[2])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[1] =
                    switchPlayerDone(PopupTextViewT2[2], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[1]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT2[3])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[2] =
                    switchPlayerDone(PopupTextViewT2[3], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[2]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
        if (v == PopupTextViewT2[4])
        {
            TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[3] =
                    switchPlayerDone(PopupTextViewT2[4], TournamentData.TeamListFinal.get((TournamentData.LastMatchNr*2)+1).doneList[3]);
            MatchDoneList[TournamentData.LastMatchNr] = CheckGameDone(TournamentData.LastMatchNr);
            NextRound();
        }
    ...
    public void PopupSetup(int MatchNr)
    {
        ...
        PopupTextViewT1[0].setText(TournamentData.TeamListFinal.get((MatchNr*2)).getTeamName());
        if (TournamentData.TeamListFinal.get((MatchNr*2)).isTeamDone())
        {
            PopupTextViewT1[0].setTextColor(Color.parseColor("#0C6D29"));
            PopupTextViewT2[0].setTextColor(Color.parseColor("#8A0808"));
        }

        PopupTextViewT2[0].setText(TournamentData.TeamListFinal.get((MatchNr*2)+1).getTeamName());
        if (TournamentData.TeamListFinal.get((MatchNr*2)+1).isTeamDone())
        {
        ...
        {
            PopupTextViewT1[i].setText(TournamentData.TeamListFinal.get((MatchNr*2)).TeamPlayerList.get(i-1).getPlayerName());
            PopupTextViewT2[i].setText(TournamentData.TeamListFinal.get((MatchNr*2)+1).TeamPlayerList.get(i-1).getPlayerName());
            PopupTextViewT1[i].setVisibility(View.VISIBLE);
            PopupTextViewT2[i].setVisibility(View.VISIBLE);

            if (TournamentData.TeamListFinal.get((MatchNr*2)).doneList[i-1])
            {
                PopupTextViewT1[i].setTextColor(Color.parseColor("#0C6D29"));
            }
            if (TournamentData.TeamListFinal.get((MatchNr*2)+1).doneList[i-1])
            {
    ...
    private void NextRound()
    {
        ...
        for (int i=0; i<2;i++)
        {
            if (TournamentData.TeamListFinal.get(i*2).isTeamDone())
            {
                WinnerList.add(TournamentData.TeamListFinal.get(i*2));
                LoserList.add(TournamentData.TeamListFinal.get(i*2+1));
            }
            else {
                WinnerList.add(TournamentData.TeamListFinal.get(i*2+1));
                LoserList.add(TournamentData.TeamListFinal.get(i*2));
            }
        }
        TournamentData.TeamListResult.add(LoserList.get(0));
        TournamentData.TeamListResult.add(WinnerList.get(0));
        TournamentData.TeamListResult.add(LoserList.get(1));
        TournamentData.TeamListResult.add(WinnerList.get(1));

        Intent Results = new Intent(getApplicationContext(), C_TournamentResult.class);
